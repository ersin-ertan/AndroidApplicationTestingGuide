...
//
///**
// * Created by ersin on 25/02/15 at 8:58 PM
// */
//
//
//public class MyFirstProjectActivityTests extends ActivityInstrumentationTestCase2<MainActivity> {
//
...
//	  mLink = (TextView)mActivity.findViewById(R.id.link);
//	  mMessage = (EditText)mActivity.findViewById(R.id.message);
//	  mCapitalize = (Button)mActivity.findViewById(R.id.capitalize);
//   }
//
//   /* (non-Javadoc)
...
//	  final String actual = mMessage.getText()
//									.toString();
...
//	  requestMessageFocus();
//
//	  sendKeys(KeyEvent.KEYCODE_H, KeyEvent.KEYCODE_E, KeyEvent.KEYCODE_E, KeyEvent.KEYCODE_E, KeyEvent.KEYCODE_Y, KeyEvent.KEYCODE_ALT_LEFT, KeyEvent.KEYCODE_1, KeyEvent.KEYCODE_DPAD_DOWN, KeyEvent.KEYCODE_ENTER);
//
...
//	  requestMessageFocus();
//
//	  sendRepeatedKeys(1, KeyEvent.KEYCODE_H, 3, KeyEvent.KEYCODE_E, 1, KeyEvent.KEYCODE_Y, 1, KeyEvent.KEYCODE_ALT_LEFT, 1, KeyEvent.KEYCODE_1, 1, KeyEvent.KEYCODE_DPAD_DOWN, 1, KeyEvent.KEYCODE_ENTER);
//
//	  final String expected = "HEEEY!";
//	  final String actual = mMessage.getText()
//									.toString();
